    ...
    >
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 z-20 text-center">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-4 animate-fadeInSlow">
            {t('hero.title')}
          </h1>
        ...
        <div className="absolute bottom-10 left-1/2 transform -translate-x-1/2 z-20 animate-bounce">
          <a href="#about" className="text-white/50 hover:text-white flex flex-col items-center">
