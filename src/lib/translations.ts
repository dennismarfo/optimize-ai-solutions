...
export const translations = {
  en: {
    ...
    testimonials: {
      ...
      client2: {
        ...
        quote: "Our reservation system and customer follow-ups now run automatically. It's like having an extra staff member who works 24/7."
      },
      client3: {
        name: "Alex Thompson",
        business: "E-commerce Entrepreneur",
        quote: "From order tracking to inventory management, everything is now seamlessly automated. Customer satisfaction is up and my stress levels are down!"
      }
    },
    contact: {
  ...
  fr: {
    ...
    testimonials: {
      ...
      client2: {
        name: "Michel Dupont",
        business: "Propriétaire de Restaurant",
        quote: "Notre système de réservation et nos suivis clients fonctionnent maintenant automatiquement. C'est comme avoir un membre du personnel supplémentaire qui travaille 24/7."
      },
      client3: {
        name: "Alex Thompson",
